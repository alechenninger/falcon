...
type UsersetsObserver interface {
	...
	ApplyChangeStarted(ctx context.Context, change Change) (context.Context, ApplyChangeProbe)
...
func (NoOpUsersetsObserver) ApplyChangeStarted(ctx context.Context, _ Change) (context.Context, ApplyChangeProbe) {
...
func (NoOpApplyChangeProbe) Applied(StoreTime) {}
...
func (o *SignalingObserver) ApplyChangeStarted(ctx context.Context, _ Change) (context.Context, ApplyChangeProbe) {
...
func (o *SignalingObserver) WaitForTime(t StoreTime) {
	o.mu.Lock()
	defer o.mu.Unlock()
...
func (o *SignalingObserver) LastTime() StoreTime {
	o.mu.Lock()
	defer o.mu.Unlock()
	return o.lastTime
}
...
func (p *signalingProbe) Applied(t StoreTime) {
	p.observer.mu.Lock()
...
type MVCCProbe interface {
	...
	Result(found bool, stateTime StoreTime)
...
func (NoOpMVCCObserver) SnapshotWithinStarted(_ StoreTime) MVCCProbe {
	return NoOpMVCCProbe{}
}
