...
func NewRemoteGraph(client graphpb.GraphServiceClient, s *domain.Schema) *RemoteGraph {
	return &RemoteGraph{
		client: client,
		schema: s,
	}
...
// Schema returns the authorization domain.
func (g *RemoteGraph) Schema() *domain.Schema {
	return g.schema
}
